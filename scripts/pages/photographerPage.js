...
function sortBy(type) {
  ...
  dropdownIcon.classList.add("dropdown__icon", "fa-solid", "fa-chevron-down");
  ...
  dropdownButton.innerHTML = type + dropdownIcon.outerHTML;
...
function handleLightboxKeyNavigation(event) {
  if (event.key === "ArrowLeft") {
    ...
    event.key === "Tab" &&
    document.activeElement === document.querySelector("#navigate-right")
  ) {
